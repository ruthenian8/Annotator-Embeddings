...
#SBATCH --output=../experiment-results/cartography/humor/%x-%j.log
#SBATCH --job-name=cartography-humor-deberta-base
...
mkdir -p ../experiment-results/cartography/humor

for i in {0..9}
do
    seed=${SEEDS[$i]}
    output_csv_seed=../experiment-results/cartography/humor/cartography_deberta_multichoice_humor_seed_${seed}.csv
