...
#SBATCH --output=../experiment-results/cartography/sentiment/%x-%j.log
...
output_csv=../experiment-results/cartography/sentiment/cartography_deberta_multichoice_sentiment.csv

SEEDS=(32 42 52 62 72 82 92 102 112 122)

mkdir -p ../experiment-results/cartography/sentiment
